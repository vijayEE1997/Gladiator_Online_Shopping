...
public ProductForApprovalDTO(int pReqId, String pCategory, String pSubCategory, String pImage, String pName, double pPrice,
		String pDesc, String pBrand, int pStock, char pStatus, int rId) {
	super();
	this.pReqId = pReqId;
	this.pCategory = pCategory;
	this.pSubCategory = pSubCategory;
